...
<html lang="en-US" dir="ltr">
  ...
  <head>
    ...
    <!--    Document Title-->
    <!-- ===============================================-->
    <title>Ensurance | Landing &amp; Corporate Template</title>
        ...
        <div class="container-fluid px-0">
          <div class="row g-0">
            <div class="col-12 col-xxl-11 offset-xxl-1">
              <h2 class="text-light text-center">Our Awesome developer</h2>
                          ...
                          <div class="card-body pt-0 p-md-0">
                            <div class="d-flex flex-column flex-md-row align-items-center">
                              <div class="card-span-img">
                                <div class="circle-wrapper"><img class="rounded-circle w-100" src="assets/img/team/ali.jpg" alt="" /></div>
                              </div>
                              <div class="mt-n6 mt-md-0 text-center text-md-start px-md-6 px-xl-8 px-xxl-10">
                                <h4 class="mb-0 fw-medium text-white">Ali mocro</h4>
                                <p class="fw-normal mb-0 text-primary">fullstack developer</p>
      ...
      <section class="py-0">
        ...
        <div class="container">
          <div class="row align-items-center justify-content-xl-between">
            ...
            <div class="col-auto col-md-4 col-lg-auto my-3 text-xl-start"><img src="assets/img/gallery/syntraWit.png" height="40" alt="Partner" /></div>
